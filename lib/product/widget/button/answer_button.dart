...
class AnswerButton extends StatefulWidget {
  ...
  // required vermek yerine nullable da verebilirsin.
...
class _AnswerButtonState extends State<AnswerButton> {
  // bana bir random sayı dön.Bu sayıyı kontrol edip sana bir cevap vereceğim.
  // bu cevaba göre butonun rengini güncelle
  // cevap doğru ise yeşil yanlış ie kırmızı yap
